...
export default function SignUpPage() {
  ...
  return (
    <AuthLayout title="Create account" subtitle="Start tracking your expenses today">
      ...
      <button onClick={handleGoogle} className="btn-secondary w-full flex items-center justify-center gap-2.5">
        <svg className="w-4 h-4" viewBox="0 0 48 48">
          ...
          <path fill="#EA4335" d="M24 9.5c3.4 0 6.5 1.2 8.9 3.5l6.6-6.6C35.9 2.4 30.4 0 24 0 14.8 0 6.7 5.1 2.7 13.1l8.1 6.2C10.7 7.6 16 3.5 22 3.5H24z"/>
        </svg>
